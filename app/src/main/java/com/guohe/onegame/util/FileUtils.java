...
import static com.guohe.onegame.util.DynamicUtil.closeStream;
...
public class FileUtils {
    ...
    public String readFromAsset(String fileName) {
        ...
        try {
            is = CustomeApplication.getApplication().getAssets().open(fileName);
    ...
    private FileUtils() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(sdcardState)) {
            ...
            BASE_PATH = CustomeApplication.getApplication().getCacheDirPath();
        }
    ...
    public void copyFile(String oldPath, String newPath) {
        ...
        try {
            ...
            DynamicUtil.closeStream(inStream);
            DynamicUtil.closeStream(fs);
        }

    }

    public File getCacheDir() {
        return CustomeApplication.getApplication().getCacheDir();
    }
