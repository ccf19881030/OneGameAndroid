...
public class LabelView extends LinearLayout {
    ...
    public void draw(ViewGroup parent, final int left, final int top, boolean isLeft) {
        ...
        if (parentWidth <= 0) {
            parentWidth = GlobalConfigManage.getInstance().getScreenWidth();
        }
    ...
    private void setupLocation(int leftLoc, int topLoc) {
        ...
        tagInfo.setX(DynamicUtil.getStandDis(left, this.parentWidth));
        tagInfo.setY(DynamicUtil.getStandDis(top, this.parentHeight));
    ...
    private int getImageWidth() {
        return imageWidth <= 0 ? GlobalConfigManage.getInstance().getScreenWidth() : imageWidth;
    }
